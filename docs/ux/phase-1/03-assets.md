...
- `02-design-system.md` — デザインシステム（カラートークン、モーショントークン）
...
- MVP: 年代別に1枚の静止キャラクター画像
- Post-MVP: キャラクターフレームアニメーション（モーション毎に6〜8フレーム）を別途計画・トラッキング

| アセット | フォーマット | 備考 |
|---------|-------------|------|
| `character/young@2x.webp` | WebP | 年代: 若い |
| `character/adult@2x.webp` | WebP | 年代: 大人 |
| `character/mature@2x.webp` | WebP | 年代: シニア |
